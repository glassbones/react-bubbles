...
**Tokens are used for authentication. This gives them access to data in an application they wouldn't have otherwise**
- [ ] What steps can you take in your web apps to keep your data secure?
**encryption and requiring strong passwords on forms**
- [ ] Describe how web servers work.
**Web servers are the backend that processes network requests via HTTP**
